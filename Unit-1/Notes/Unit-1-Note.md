...
Host: www.example.com. The domain name or IP address of the server hosting the resource.
...
Example:
https://www.example.com:8080/products/electronics?category=laptops&brand=dell#specs
